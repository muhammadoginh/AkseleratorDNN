...
\author{
\IEEEauthorblockN{Reihan Augeetiansyah\IEEEauthorrefmark{1}, Elang Aditya\IEEEauthorrefmark{2}, Andaru Purwarangga\IEEEauthorrefmark{3},\\ Muhammad Ogin Hasanuddin\IEEEauthorrefmark{4}, Beni Rio Hermanto\IEEEauthorrefmark{5}}\IEEEauthorblockA{\textit{School of Electrical Engineering and Informatics} \\
\textit{Institut Teknologi Bandung}\\
Bandung, Indonesia \\
Email: \{\IEEEauthorrefmark{1}13217013, \IEEEauthorrefmark{2}13217027, \IEEEauthorrefmark{3}13217082\}@std.stei.itb.ac.id, \IEEEauthorrefmark{4}moginh@itb.ac.id, \IEEEauthorrefmark{5}benirio@gmail.com}
}
...
% change abstract to abstrak
\renewcommand{\abstractname}{Abstrak}
% change References to Referensi
